<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:54:"F:\WWW\tyms/application/admin\view\category\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box no-header clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-primary" href="<?php echo url('add'); ?>"><i class="fa fa-plus-circle fa-lg"></i> 新 增</a>
		</div>
	</header>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php echo $list['level_show']; ?>
							<a href="#" class="editable editable-click" data-id="<?php echo $list['id']; ?>" data-name="title" data-type="text" data-pk="<?php echo $list['id']; ?>" data-url="<?php echo url('editable'); ?>"><?php echo $list['title']; ?></a>
							<a class="add-sub-cate" title="添加子分类" href="<?php echo url('add?pid='.$list['id']); ?>">
								<i class="fa fa-plus-square"></i>
							</a>
						</td>
						<td><a href="#" class="editable editable-click" data-id="<?php echo $list['id']; ?>" data-name="sort" data-type="text" data-pk="<?php echo $list['id']; ?>" data-url="<?php echo url('editable'); ?>"><?php echo $list['sort']; ?></a></td>
						<td><?php echo !empty($list['allow_publish'])?'是':'否'; ?></td>
						<td>
							<?php if($list['status']): ?>
						...
						<td>
							...
							<?php if($list['status']): ?>
							<a href="<?php echo url('status?id='.$list['id'].'&status=0'); ?>" class="ajax-get">禁用</a>
							<?php else: ?>
							<a href="<?php echo url('status?id='.$list['id'].'&status=1'); ?>" class="ajax-get">启用</a>
							<?php endif; ?>
