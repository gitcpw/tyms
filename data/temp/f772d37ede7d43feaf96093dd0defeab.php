<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\phpStudy\WWW\sentcms/application/admin\view\scan\view.html";i:1495329299;s:63:"D:\phpStudy\WWW\sentcms/application/admin\view\public\base.html";i:1499699582;s:65:"D:\phpStudy\WWW\sentcms/application/admin\view\public\header.html";i:1499698928;s:63:"D:\phpStudy\WWW\sentcms/application/admin\view\public\tool.html";i:1499155829;s:65:"D:\phpStudy\WWW\sentcms/application/admin\view\public\footer.html";i:1499698928;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
    ...
    <div class="admin-main">
        <div class="layui-field-box" style="padding:0;">
            <table class="table">
                ...
                <?php if($func): ?>
                <tr>
                    <td style="text-align: left">特征函数：
                        <?php
                            if ($func) {
                                 foreach ($func as $val) {
                                    if($val) {
                                        echo "<button class='layui-btn layui-btn-mini'>".$val."</button>&nbsp;&nbsp;";
                                    }
                                 }
                            }
                        ?>
                ...
                <?php endif; if($code): ?>
                <tr>
                    <td style="text-align: left">特征代码：
                        <?php
                            if(is_array($code)) {
                                foreach ($code as $val) {
                                    if($val) {
                                        echo "<button class='layui-btn layui-btn-mini layui-btn-normal'>".new_html_special_chars($val)."</button>";
                                    }
                                }
                            }
                        ?>
                ...
                <tr>
                    <td>
                        <textarea name="code" id="code" class="form-control" style="height:650px;width:1500px;resize: none;"><?php echo new_html_special_chars($html)?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a href="javascript:;" onclick="javascript:history.back(-1);return false;" class="btn btn-danger">返回</a>
                    </td>
                </tr>
                </tbody>
            </table>
