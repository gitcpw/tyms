<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\sentcms/application/common\view\default\form\show.html";i:1499155829;}*/ ?>
<?php switch($type): case "readonly": ?>
		<input type="text" class="form-control" name="<?php echo $field; ?>" id="<?php echo $field; ?>" value="<?php echo $value; ?>" autocomplete="false" readonly>
	<?php break; case "num": ?>
	...
	<?php break; case "decimal": ?>
		<input type="text" style="width: auto;" class="form-control" name="<?php echo $field; ?>" id="<?php echo $field; ?>" autocomplete="false" value="<?php echo $value; ?>">
	<?php break; case "text": ?>
		<input type="text" class="form-control" name="<?php echo $field; ?>" id="<?php echo $field; ?>" autocomplete="false" value="<?php echo $value; ?>">
	<?php break; case "password": ?>
		<input type="password" class="form-control" name="<?php echo $field; ?>" id="<?php echo $field; ?>" autocomplete="false" value="<?php echo $value; ?>">
	...
	<?php break; case "checkbox": $value = isset($value) && is_array($value) ? $value : array(); if(is_array($option) || $option instanceof \think\Collection || $option instanceof \think\Paginator): $i = 0; $__LIST__ = $option;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
