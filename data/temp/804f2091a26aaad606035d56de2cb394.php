<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\WWW\tyms/application/admin\view\action\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box no-header clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-primary" id="action_add" href="<?php echo url('add'); ?>">新 增</a>
			<button class="btn btn-success ajax-post" target-form="ids" url="<?php echo url('setstatus?status=1'); ?>" >启 用</button>
			<button class="btn btn-default ajax-post" target-form="ids" url="<?php echo url('setstatus?status=0'); ?>">禁 用</button>
			<button class="btn btn-danger ajax-post confirm" target-form="ids" url="<?php echo url('del'); ?>">删 除</button>
		</div>
	</header>
			...
			<tbody>
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td>
							<a href="<?php echo url('edit?id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a>
						</td>
						<td>
							<span><?php echo get_action_type($vo['type']); ?></span>
						</td>
						...
						<td>
							...
							<?php if($vo['status']): ?>
							<a href="<?php echo url('setstatus',array('id'=> $vo['id'],'status'=>0)); ?>" class="ajax-get">禁用</a>
							<?php else: ?>
							<a href="<?php echo url('setstatus',array('id'=> $vo['id'],'status'=>1)); ?>" class="ajax-get">启用</a>
							<?php endif; ?>
							<a href="<?php echo url('del' , array('id' => $vo['id'])); ?>" class="confirm ajax-get">删除</a>
						</td>
					</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
