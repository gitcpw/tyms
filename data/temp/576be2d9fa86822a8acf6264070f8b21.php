<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"F:\WWW\tyms/application/admin\view\ad\lists.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box no-header clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-success" href="<?php echo url('addad?id='.$id); ?>"><i class="fa fa-plus-circle fa-lg"></i> 新 增</a>
			<a class="btn btn-primary" href="<?php echo url('index'); ?>"><i class="fa fa-list fa-lg"></i> 广告位</a>
		</div>
	</header>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?php echo url('editad?id='.$item['id']); ?>">编辑</a>
							<a href="<?php echo url('delad?id='.$item['id']); ?>" class="confirm ajax-get">删除</a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
