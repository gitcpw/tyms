<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"F:\WWW\tyms/application/admin\view\user\auth.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
		...
		<form method="post" class="form form-horizontal">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td class="info col-lg-2 text-right"><?php echo config('USER_GROUP_TYPE')[$key]; ?></td>
						<td class="col-lg-10 text-left">
							...
							<input type="radio" name="<?php echo $item['module']; ?>" value="<?php echo $item['id']; ?>" id="<?php echo $item['module']; ?>-<?php echo $item['id']; ?>" <?php if(in_array($item['id'],$auth_list)): ?>checked<?php endif; ?> />
							<label for="<?php echo $item['module']; ?>-<?php echo $item['id']; ?>"><?php echo $item['title']; ?></label>
							</div>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</td>
					</tr>
