<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"F:\WWW\tyms/application/admin\view\index\login.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
					...
					<div id="login-box">
									...
									<div id="login-box-inner">
										<form role="form" method="post">
											...
											<div class="input-group">
												...
												<span class="input-group-addon reloadverify"><img src="<?php echo url('admin/index/verify'); ?>" alt="验证码" height="40" class="verifyimg"></span>
											</div>
											<div class="row">
												<div class="col-xs-12">
						...
						<div id="login-box-footer">
							<div class="row">
								<div class="col-xs-12">
									版权所有
									&copy; <a href="http://www.yizukeji.cn" target="_blank">YizuCMS,Inc.</a>
								</div>
							</div>
						</div>
					</div>
