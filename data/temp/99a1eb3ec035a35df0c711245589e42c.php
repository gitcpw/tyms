<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"F:\WWW\tyms/application/admin\view\model\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-success" href="<?php echo url('Model/add'); ?>">新 增</a>
			<button class="btn ajax-post" target-form="ids" url="<?php echo url('Model/status',array('status'=>0)); ?>">禁 用</button>
		</div>
	</header>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><i class="fa fa-<?php echo $item['icon']; ?>"></i> <?php echo $item['name']; ?></td>
						<td>
						...
						<td>
							<a href="<?php echo url('admin/attribute/index?model_id='.$item['id']); ?>">字段</a>
							<a href="<?php echo url('model/status?id='.$item['id'].'&status='.abs(1-$item['status'])); ?>" class="ajax-get"><?php echo show_status_op($item['status']); ?></a>
							<a href="<?php echo url('model/edit?id='.$item['id']); ?>">编辑</a>
							<a href="<?php echo url('model/del?id='.$item['id']); ?>" class="confirm ajax-get">删除</a>
							<a href="<?php echo url('admin/content/index?model_id='.$item['id']); ?>">数据</a>
						</td>
					</tr>
