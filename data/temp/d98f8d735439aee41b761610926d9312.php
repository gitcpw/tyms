<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\phpStudy\WWW\sentcms/application/install\view\index\config.html";i:1499699415;s:65:"D:\phpStudy\WWW\sentcms/application/install\view\public\base.html";i:1499698928;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<form method="post" target="_self">
	<div class="create-database">
		...
		<table class="table-hover table">
			...
			<tr>
				<td>
					<input class="form-control" name="db[]" type="text" value="lx_" class="form-control">
					</input>
				</td>
				<td>
					<span>
