<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:50:"F:\WWW\tyms/application/admin\view\link\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			...
			<button class="btn btn-danger ajax-post confirm" url="<?php echo url('delete'); ?>" target-form="ids">删 除</button>
		</div>
	</header>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?php echo url('edit?id='.$item['id']); ?>">编辑</a>
							<a href="<?php echo url('delete?id='.$item['id']); ?>" class="confirm ajax-get">删除</a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
