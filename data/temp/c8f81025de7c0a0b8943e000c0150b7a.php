<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpStudy\WWW\YizuCMS/application/admin\view\wechat\menu.html";i:1495336801;s:63:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\base.html";i:1499699582;s:65:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\header.html";i:1499698928;s:63:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\tool.html";i:1499155829;s:65:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\footer.html";i:1499698928;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-primary" href="<?php echo url('add_menu'); ?>"><i class="fa fa-plus-circle fa-lg"></i> 新增菜单</a>
			<a class="btn btn-primary" href="<?php echo url('Admin/Wechat/pub_menu'); ?>"><i class="fa fa-cloud-upload"></i> 发布</a>
		</div>
	</header>
			...
			<table class="table">
				<thead>
					<tr>
						...
						<th style="text-align: left">菜单URL</th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody>
				...
				<tr>
					<td style="text-align: left"><?php echo $vo['_name']; ?></td>
					<td style="text-align: left"><?php echo $typeArr[$vo['type']]; ?></td>
					<td style="text-align: left"><?php echo $vo['value']; ?></td>
					<td>
						<a class="layui-btn layui-btn-mini" href="<?php echo URL('edit_menu',['id'=>$vo['id']]); ?>" ><i class="fa fa-cog"></i> 编辑</a>&nbsp;&nbsp;
						<a class="layui-btn layui-btn-danger layui-btn-mini" href="<?php echo URL('del_menu',['id'=>$vo['id']]); ?>"><i class="fa fa-trash-o"></i> 删除</a>
					</td>
				</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
