<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:50:"F:\WWW\tyms/application/admin\view\action\log.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box no-header clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
        	<a class="btn btn-warning ajax-get confirm" href="<?php echo url('clear'); ?>">清 空</a>
			<button class="btn btn-danger ajax-post confirm" target-form="ids" url="<?php echo url('dellog'); ?>">删 除</button>
		</div>
	</header>
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="<?php echo url('detail?id='.$vo['id']); ?>">详细</a>
						<a class="confirm ajax-get" href="<?php echo url('dellog?id='.$vo['id']); ?>">删除</a>
		                </td>
				</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
