<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:50:"F:\WWW\tyms/application/admin\view\group\auth.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a href="<?php echo url('Group/index'); ?>" class="btn btn-danger">
		...
		<div class="table-responsive clearfix">
			<form action="" class="form" method="post">
				<table class="table table-striped">
					...
					<tbody>
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?>
						<tr>
							<td class="info col-lg-2 text-right"><?php echo $key; ?></td>
							<td class="col-lg-10 text-left">
								<?php if(is_array($node) || $node instanceof \think\Collection || $node instanceof \think\Paginator): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
								<div class="checkbox-nice checkbox-inline">
								<input type="checkbox" name="rule[]" value="<?php echo $item['id']; ?>" id="<?php echo $item['name']; ?>" <?php if(in_array($item['id'],$auth_list)): ?>checked<?php endif; ?> />
						...
						<tr>
							...
							<td class="col-lg-10 text-left">
								<?php if(is_array($model) || $model instanceof \think\Collection || $model instanceof \think\Paginator): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
								<div class="checkbox-nice checkbox-inline">
								<input type="checkbox" name="extend_rule[2][]" value="<?php echo $item['id']; ?>" id="<?php echo $item['name']; ?>" <?php if(in_array($item['id'],$extend_auth)): ?>checked<?php endif; ?> />
								<label for="<?php echo $item['name']; ?>"><?php echo $item['title']; ?></label>
								</div>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</td>
