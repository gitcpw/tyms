<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\phpStudy\WWW\YizuCMS/application/admin\view\wechat\img.html";i:1495339007;s:63:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\base.html";i:1499699582;s:65:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\header.html";i:1499698928;s:63:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\tool.html";i:1499155829;s:65:"D:\phpStudy\WWW\YizuCMS/application/admin\view\public\footer.html";i:1499698928;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
    <header class="main-box-header clearfix">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo url('add_img'); ?>"><i class="fa fa-plus-circle fa-lg"></i> 添加图文</a>
        </div>
    </header>
            ...
            <table class="table">
                ...
                <tr >
                    <td align="left" abbr="order_sn" axis="col3" class="">
                        <div style="text-align: left; width: 160px;" class=""><?php echo $list['keyword']; ?></div>
                    </td>
                    <td align="left" abbr="article_time" axis="col6" class="">
                        <div style="text-align: left; width: 120px;" class=""><?php echo $list['title']; ?></div>
                    </td>
                    <td align="left" abbr="article_time" axis="col6" class="">
                        <div style="text-align: left; width: 320px;" class=""><?php echo $list['desc']; ?></div>
                    </td>
                    <td align="left"  axis="col6" class="">
                        <a class="layui-btn layui-btn-mini" href="<?php echo URL('add_img',['id'=>$list['id'],'edit'=>1]); ?>" ><i class="fa fa-cog"></i> 编辑</a>&nbsp;&nbsp;
                        <a class="layui-btn layui-btn-danger layui-btn-mini" href="<?php echo URL('del_img',['id'=>$list['id']]); ?>"><i class="fa fa-trash-o"></i> 删除</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
