<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\WWW\tyms/application/admin\view\addons\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="main-box clearfix">
	<header class="main-box-header clearfix">
		...
		<div class="pull-right">
			<a class="btn btn-info" href="<?php echo url('index?refresh=1'); ?>">更 新</a>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo (isset($item['id']) && ($item['id'] !== '')?$item['id']:0); ?></td>
						...
						<td>
							<?php if(!$item['isinstall']): ?>
							<a href="<?php echo url('install?addon_name='.$item['name']); ?>" class="ajax-get">安装</a>
							<?php else: ?>
							<a href="<?php echo url('uninstall?id='.$item['id']); ?>" class="confirm ajax-get">卸载</a>
							<?php if($item['status']): ?>
							<a href="<?php echo url('disable?id='.$item['id']); ?>" class="confirm ajax-get">禁用</a>
							<?php else: ?>
							<a href="<?php echo url('enable?id='.$item['id']); ?>" class="confirm ajax-get">启用</a>
							<?php endif; ?>
							<a href="<?php echo url('config?id='.$item['id']); ?>">设置</a>
							<?php endif; ?>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
