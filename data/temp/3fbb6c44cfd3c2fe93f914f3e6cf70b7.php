<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"F:\WWW\tyms/application/admin\view\ad\index.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\base.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\header.html";i:1500196927;s:51:"F:\WWW\tyms/application/admin\view\public\tool.html";i:1500196927;s:53:"F:\WWW\tyms/application/admin\view\public\footer.html";i:1500196927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a title="广告列表" href="<?php echo url('lists?id='.$item['id']); ?>">广告列表</a>
							<a title="移动" href="<?php echo url('edit?id='.$item['id']); ?>">编辑</a>
							<a title="删除" href="<?php echo url('del?id='.$item['id']); ?>" class="confirm ajax-get">删除</a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
