...
(15, 'web_site_url', 'text', '网站URL', 1, '', '网站网址', '', 1378898976, 1379235274, 1, 'http://www.yizukeji.cn', 1),
...
CREATE TABLE IF NOT EXISTS `sent_wx_img` (
...
INSERT INTO `sent_wx_img` (`id`, `keyword`, `desc`, `pic`, `url`, `createtime`, `uptatetime`, `token`, `title`, `goods_id`, `goods_name`) VALUES
(26, 'demo', 'dss', '3', 'demo', '1495338515', '', 'eesops1462769263', 'demo', 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `sent_wx_keyword`
--

CREATE TABLE IF NOT EXISTS `sent_wx_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '表id',
  `keyword` char(255) NOT NULL COMMENT '关键词',
...
--
-- 转存表中的数据 `sent_wx_keyword`
--

INSERT INTO `sent_wx_keyword` (`id`, `keyword`, `pid`, `token`, `type`) VALUES
...
CREATE TABLE IF NOT EXISTS `sent_wx_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信菜单' AUTO_INCREMENT=37 ;

--
-- 转存表中的数据 `sent_wx_menu`
--

INSERT INTO `sent_wx_menu` (`id`, `level`, `name`, `sort`, `type`, `value`, `token`, `pid`) VALUES
(34, 1, '首页', 0, 'view', 'http://www.qq.com', 'eesops1462769263', 0),
(35, 2, '二级菜单', 0, 'view', 'http://www.baidu.com', 'eesops1462769263', 34);
...
CREATE TABLE IF NOT EXISTS `sent_wx_msg` (
...
CREATE TABLE IF NOT EXISTS `sent_wx_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '表id',
...
CREATE TABLE IF NOT EXISTS `sent_wx_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '表id',
...
--
-- 转存表中的数据 `sent_wx_text`
--

INSERT INTO `sent_wx_text` (`id`, `uid`, `uname`, `keyword`, `precisions`, `text`, `createtime`, `updatetime`, `click`, `token`) VALUES
